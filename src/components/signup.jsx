...
const Signup = ({setIsAuthenticated}) => {
    ...
    return (
        ...
        <div className="flex justify-center items-center h-screen bg-[#111] max-md:h-[100vw] max-md:mt-40">
            <div className="signup w-96 h-96 flex flex-col justify-between items-center bg-slate-800 p-4 rounded-xl shadow-md max-md:w-80">
                ...
                <button
                    type="submit"
                    className="w-80 h-10 flex justify-evenly items-center max-md:w-52 bg-blue-700 border-2 border-slate-800 text-center text-white rounded-md ml-3 max-md:bottom-0"
                >Sign Up</button>
