...
const developerCard = ({ setShowProductCard, showProductCard }) => {
    return (
        <>
            <div className="developer-card p-6  absolute right-20 bg-slate-800 rounded-lg shadow-lg w-80 mt-8 max-md:right-8">
                <div className="flex flex-col items-center">
                    <i onClick={() => setShowProductCard(!showProductCard)} className="ri-close-large-line top-0 bg-slate-800 absolute text-text-slate-400 hover:text-teal-300 right-6"></i>
